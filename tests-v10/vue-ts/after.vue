...
function calculateStats() {
  ...
  let total = 0;
  for (let i = 0; i < userData.value.history.length; i++) {
    total += 1;
  }
  return total;
}
...
<template>
  ...
  >
    ...
    <div
      class="stats-bar"
      style="display: flex; gap: 15px; background: #f0f0f0; padding: 10px;"
    >
      <div class="stat-item">
      ...
      <div class="stat-item">
        ...
        <span
          v-if="userData.preferences.notifications"
          style="color: green;"
        >Active</span>
        <span
          v-else
    ...
    <div
      class="footer"
      style="margin-top: 50px; text-align: center; color: #888;"
    >
      <p>Copyright 2023</p>
      <a
